...
func main() {
    ...
    registry := *openapiclient.NewNewRegistry("Id_example") // NewRegistry | application/json
...
> ListDeviceRegistriesResponse GetRegistries(ctx, subscriptionId).PageNumber(pageNumber).PageSize(pageSize).Execute()
...
func main() {
    ...
    // response from `GetRegistries`: ListDeviceRegistriesResponse
...
func main() {
    ...
    registry := *openapiclient.NewUpdateRegistry() // UpdateRegistry | application/json
